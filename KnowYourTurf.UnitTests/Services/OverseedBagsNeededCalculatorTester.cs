...
{
    public class OverseedBagsNeededCalculatorTester
    {
    }

    [TestFixture]
    public class when_calling_calculate_on_the_overseed_bags_calc
    {
        private Field _field;
        private InventoryProduct _product;
        private OverseedBagsNeededCalculator _SUT;
        ...
        public void Setup()
        {
            ...
            _SUT = new OverseedBagsNeededCalculator(_repo, new UnitSizeTimesQuantyCalculator(),null);
        ...
        {
            ((OverseedBagsNeededCalcViewModel) _result.Target).BagsNeeded.ShouldEqual(12.12);
        }
    }
}