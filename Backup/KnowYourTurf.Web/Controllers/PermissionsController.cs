...
namespace KnowYourTurf.Web.Controllers
{
    public class PermissionsController : KYTController
    {
        ...
        public ActionResult ShowPermissions()
        {
            ...
            _permissionsService.GetPermissionsFor(user1).ForEachItem(x => permissions1.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions1);
            _authorizationRepository.GetAssociatedUsersGroupFor(user1).ForEachItem(x => permissions1.userGroupList.Add(x.Name));
            
            var permissions2= new Permissions{UserName = user2.FullNameLNF, PermList = new List<string>()};
            _permissionsService.GetPermissionsFor(user2).ForEachItem(x => permissions2.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions2);
            _authorizationRepository.GetAssociatedUsersGroupFor(user2).ForEachItem(x => permissions2.userGroupList.Add(x.Name));
            
            var permissions3 = new Permissions { UserName = user3.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user3).ForEachItem(x => permissions3.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions3);
            _authorizationRepository.GetAssociatedUsersGroupFor(user3).ForEachItem(x => permissions3.userGroupList.Add(x.Name));
            
            var permissions4 = new Permissions { UserName = user4.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user4).ForEachItem(x => permissions4.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions4);
            _authorizationRepository.GetAssociatedUsersGroupFor(user4).ForEachItem(x => permissions4.userGroupList.Add(x.Name));
            
            var permissions5 = new Permissions { UserName = user5.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user5).ForEachItem(x => permissions5.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions5);
            _authorizationRepository.GetAssociatedUsersGroupFor(user5).ForEachItem(x => permissions5.userGroupList.Add(x.Name));
            
            var permissions6 = new Permissions { UserName = user6.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user6).ForEachItem(x => permissions6.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions6);
            _authorizationRepository.GetAssociatedUsersGroupFor(user6).ForEachItem(x => permissions6.userGroupList.Add(x.Name));
            
            var permissions7 = new Permissions { UserName = user7.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user7).ForEachItem(x => permissions7.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions7);
            _authorizationRepository.GetAssociatedUsersGroupFor(user7).ForEachItem(x => permissions7.userGroupList.Add(x.Name));
            
            var permissions8 = new Permissions { UserName = user8.FullNameLNF, PermList = new List<string>() };
            _permissionsService.GetPermissionsFor(user8).ForEachItem(x => permissions8.PermList.Add(x.Operation.Name));
            model.Permissions.Add(permissions8);
            _authorizationRepository.GetAssociatedUsersGroupFor(user8).ForEachItem(x => permissions8.userGroupList.Add(x.Name));
            return View(model);
