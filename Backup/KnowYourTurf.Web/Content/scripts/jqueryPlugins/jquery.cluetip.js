...
//activate clueTip
    var activate = function(event) {
      ...
      if(opts.closeOnMouseOutOfTip){
          $cluetip.mouseenter(function(){
                  isHovering = true;
                  $cluetip.mouseleave(function(){
                              inactivate(event);
  ...
  // activate by hover
        ...
        if ($.fn.hoverIntent && opts.hoverIntent) {
          $link.hoverIntent({
            ...
            out: function(event) { if(opts.closeOnMouseOutOfTip && isHovering)return; inactivate(event); $link.unbind('mousemove.cluetip');}
          });
        } else {
