            ...
            return _builder
                ...
                //.CreateNode<EmailTemplateListController>(c => c.EmailTemplateList(null), WebLocalizationKeys.EMAIL_TEMPLATES)
                        ...
                        .HasChildren()
                            ...
                            .CreateTagNode<InventoryListController>(WebLocalizationKeys.FERTILIZERS).Route("inventorylist/0/0/0/Material")//, "ProductType=Fertilizer")
                            .CreateTagNode<InventoryListController>(WebLocalizationKeys.CHEMICALS).Route("inventorylist/0/0/0/Material")//, "ProductType=Chemical")
                        .EndChildren()
