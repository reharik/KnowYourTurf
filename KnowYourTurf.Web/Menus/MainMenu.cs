        ...
        private IList<MenuItem> DefaultMenubuilder(bool withoutPermissions = false)
        {
            return _builder
                ...
                .CreateNode(WebLocalizationKeys.TASKS)
                    .HasChildren()
                    .CreateNode<TaskListController>(c => c.TaskList(null), WebLocalizationKeys.TASK_LIST)
                    .CreateNode<TaskCalendarController>(c => c.TaskCalendar(null), WebLocalizationKeys.TASK_CALENDAR)
                    .EndChildren()
                .CreateNode<EventCalendarController>(c => c.EventCalendar(null), WebLocalizationKeys.EVENTS)
                .EndCategoryGroup()
