...
kyt.CalculatorController = kyt.CrudController.extend({
    ...
    additionalSubscriptions:function(){
        $.subscribe('/popupFormModule_taskModule/popupLoaded',$.proxy(this.loadTokenizers,this), this.cid);
        $.subscribe('/form_taskModule/success', $.proxy(this.taskSuccess,this), this.cid);
        $.subscribe('/form_taskModule/cancel', $.proxy(this.taskCancel,this), this.cid);
    },
