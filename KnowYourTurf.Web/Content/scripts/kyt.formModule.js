...
kyt.FormModule  = kyt.Module.extend({
    ...
    initialize:function(){
            ...
            this.views.formView = new kyt.FormView(this.options);
        },

        registerSubscriptions: function(){
            $.subscribe("/contentLevel/form_"+this.id+"/success", $.proxy(this.formSuccess,this), this.cid,"formMod");
            $.subscribe("/contentLevel/form_"+this.id+"/cancel", $.proxy(this.formCancel,this), this.cid,"formMod");
...
kyt.AjaxFormModule  = kyt.Module.extend({
    events:_.extend({
    }, kyt.Module.prototype.events),
