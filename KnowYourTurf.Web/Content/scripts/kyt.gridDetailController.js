...
kyt.gridDetailController = function(container, options){
    ...
    return{
        ...
        setupTokenInputControllers: function(){
            var docController = kyt.tokenModule("#documentTokenContainer",extraFormOptions.docOptons);
            var photoController = kyt.tokenModule("#photoTokenContainer",extraFormOptions.photoOptons);
            modules.docTokenController = docController;
            modules.photoTokenController = photoController;
            modules.docTokenController.init();
            modules.photoTokenController.init();
        },
