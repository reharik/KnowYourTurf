...
*/
    ...
    //REH
    // set the selectedValues array up on the settings object
    settings.selectedValues = li_data;
    ...
    function insert_token(item) {
        //REH changed to append
        var this_token = $("<li>").append(settings.internalTokenMarkup(item))
