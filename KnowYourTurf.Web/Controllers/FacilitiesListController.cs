       ...
       private readonly IEntityListGrid<User> _gridHandlerService;
        ...
        public ActionResult FacilitiesList()
        {
            ...
            ListViewModel model = new ListViewModel()
            {
                ...
                ListDefinition = _gridHandlerService.GetGridDefinition(url),
            };
            return View(model);
        }
        ...
        {
            var items = _dynamicExpressionQuery.PerformQuery<User>(input.filters, x=>x.UserLoginInfo.UserType==UserType.Facilities.ToString());
